...
namespace GestaoDeEquipamentos.ConsoleApp
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            DateTime dataEquipamentos = DateTime.MinValue;
            ...
            DateTime dataChamados = DateTime.MinValue;
            ...
            do
            {
                ...
                {
                    case "1":
                        nomeDoEquipamento = CriarEquipamento(nomesDosEquipamentos, precoDoEquipamento, numeroDeSerie, dataDeFabricacao, fabricante, ref countEquipamentos);
                        break;

                    case "2":
                        VisualizarEquipamento(nomesDosEquipamentos, numeroDeSerie, fabricante, countEquipamentos);
                        break;

                    case "3":
                        opcaoEditar = EditarEquipamento(nomesDosEquipamentos, precoDoEquipamento, numeroDeSerie, dataDeFabricacao, fabricante, countEquipamentos, opcaoEditar);
                        break;

                    case "4": // nao pode exluir equipamento que esta em um chamado 
                        ExcluirEquipamento(nomesDosEquipamentos, numeroDeSerie, fabricante, countEquipamentos);

                        break;

                    case "5":

                        opcaoChamado = Chamado(nomesDosEquipamentos, countEquipamentos, nomesDosChamados, descricoesDosChamados, equipamentosDosChamados, datasAberturaChamados, ref countChamados, ref opcaoEditarChamado, ref dataChamados);
                        break;
                }
        ...
        private static string Chamado(string[] nomesDosEquipamentos, int countEquipamentos, string[] nomesDosChamados, string[] descricoesDosChamados, string[] equipamentosDosChamados, DateTime[] datasAberturaChamados, ref int countChamados, ref string opcaoEditarChamado, ref DateTime dataChamados)
        {
            string opcaoChamado;
            while (true)
            {
                ...
                {
                    case "1":
                        dataChamados = CriarChamado(nomesDosEquipamentos, countEquipamentos, nomesDosChamados, descricoesDosChamados, equipamentosDosChamados, datasAberturaChamados, ref countChamados);

                        continue;

                    case "2":

                        opcaoChamado = VisualizarChamado(nomesDosChamados, equipamentosDosChamados, datasAberturaChamados, countChamados, opcaoChamado);
                        continue;
        ...
        private static string VisualizarChamado(string[] nomesDosChamados, string[] equipamentosDosChamados, DateTime[] datasAberturaChamados, int countChamados, string opcaoChamado)
        {
            if (countChamados != 0)
            {
                for (int i = 0; i < countChamados; i++)
        ...
        private static DateTime CriarChamado(string[] nomesDosEquipamentos, int countEquipamentos, string[] nomesDosChamados, string[] descricoesDosChamados, string[] equipamentosDosChamados, DateTime[] datasAberturaChamados, ref int countChamados)
        {
            DateTime dataChamados;
            Console.Clear();
        ...
        private static void ExcluirEquipamento(string[] nomesDosEquipamentos, string[] numeroDeSerie, string[] fabricante, int countEquipamentos)
        {
        ...
        private static string EditarEquipamento(string[] nomesDosEquipamentos, string[] precoDoEquipamento, string[] numeroDeSerie, DateTime[] dataDeFabricacao, string[] fabricante, int countEquipamentos, string opcaoEditar)
        {
            Console.Clear();
            do
            {
        ...
        private static void VisualizarEquipamento(string[] nomesDosEquipamentos, string[] numeroDeSerie, string[] fabricante, int countEquipamentos)
        {
            Console.Clear();
            if (countEquipamentos != 0)
            {
        ...
        private static string CriarEquipamento(string[] nomesDosEquipamentos, string[] precoDoEquipamento, string[] numeroDeSerie, DateTime[] dataDeFabricacao, string[] fabricante, ref int countEquipamentos)
        {
            string nomeDoEquipamento;
            do
            {
